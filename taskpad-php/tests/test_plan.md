...
### c. Filter tasks. url should display index.php?q={filter}&priority={priority} test values-cat and no priority, high priority.

![Test c](image-2.png)
![Test c](image-3.png)

### d. Delete a task. Should return a 302 status code and update the page without the deleted task. Test: Delete test task
